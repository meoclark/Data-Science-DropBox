# This code checks for negative or positive comments
from reviews import counter, training_counts
from sklearn.feature_extraction.text import CountVectorizer
from sklearn.naive_bayes import MultinomialNB

# Add your review:
review = "The lesson so far has been enlightening though am still trying to grab the new models being used. so far it has been well educative"
