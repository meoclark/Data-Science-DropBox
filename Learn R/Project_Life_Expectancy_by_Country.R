...
```{r error=TRUE}
# life expectancy
# In order to utilize the function for calculating quantiles, we need to convert the data frame column into a vector. We can do this by replacing the call to select() with the dplyr function pull().
